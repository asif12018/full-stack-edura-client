                            ...
                            <div className="flex flex-col justify-center items-center bg-gray-100 ">
                                <div className="bg-white rounded-lg shadow-lg overflow-hidden w-full">
                                    ...
                                    <div className="p-6">
                                        ...
                                        >Delete</button>
                                       {
                                        course?.isApproved == 'yes' ?  <Link to={`/dashboard/courseProgress/${course?._id}`} className="btn w-full bg-[#14452f] text-white">See Details..</Link>: <button className="btn w-full" disabled>See Details</button>
                                       }
