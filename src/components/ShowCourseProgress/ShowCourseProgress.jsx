...
const ShowCourseProgress = () => {
    ...
    const [courseDetails, isLoading, refetch] = useTeacherSingleCourse(id);
    if(isLoading){
    ...
    return (
        <div>
            <div>
            <section className=" bg-[#14452f]">
    <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:-mx-6">
            <div className="lg:w-3/4 lg:px-6">
                <img className="object-cover object-center w-full h-80 xl:h-[28rem] rounded-xl" src={courseDetails?.coursePhoto} alt=""/>
...
export default ShowCourseProgress;